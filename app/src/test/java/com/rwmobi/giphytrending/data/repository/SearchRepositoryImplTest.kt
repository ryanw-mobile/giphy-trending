...
class SearchRepositoryImplTest {
    ...
    fun search_WithValidKeyword_ShouldReturnSuccessfulResult() = runTest {
        ...
        searchResult.isSuccess shouldBe true
        searchResult.getOrNull() shouldBe SampleSearchNetworkResponse.singleResponse.trendingData.asTrendingEntity().toGifObject()
    }
    ...
    fun getLastSuccessfulSearch_WithSuccessfulSearch_ShouldReturnKeywordAndResults() = runTest {
        ...
        lastSuccessfulSearchResults shouldBe SampleSearchNetworkResponse.singleResponse.trendingData.asTrendingEntity().toGifObject()
    }
